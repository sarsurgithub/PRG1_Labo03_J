/*
  ...
  Date        : 27/10/2020
  But         : Le but du programme est d'afficher le calendrier d'une année précise
  					 entre 1900 et 2100. L'utilisateur choisi l'année qu'il veut afficher.
  					 À la fin du programme, ce dernier peut choisir de recommencer l'opération
  					 en choisisant une nouvelle année autant de fois qu'il le souhaite.
...
int main() {
   ...
   do {
      ...
      // ----------------------------------------------------------------------------------------------
      //Chercher si l'année entrée est bissextile
